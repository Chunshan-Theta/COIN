...
<div id="wrapper">
	<fieldset id="register_field">
		...
		<hr>
		  	...
		  	<p style="text-indent: 17px;">暱稱：<input type="text" name="nickname" size="15"/></p>
		  	<p><em>*</em>生日：
		  	...
		  	<p style="display: none">身份：<input type="input" name="identity" value="T"/></p>
		  	...
		  	<p><em>*</em>任職學校：<input type="text" name="school_name" size="10" placeholder="學校名稱"/>
			...
			<p style="display: none">年級：
					<select name="grade" value="0">
						<option value="0">零年級</option>
					</select></p>
		    <p style="display: none">指導老師：<input type="text" name="teacher" value="NULL" /></p>
			<p><em>*</em>信箱：<input type="email" name="email" size="30" placeholder="電子信箱"/></p>
