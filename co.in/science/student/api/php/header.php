...
<div id="wrapper">
	<div id="header">
		...
		<div class="log_btn" id="index_btn" value="專題探究學習系統LOGO" data-step="1" data-intro="您好，歡迎來到Let's Inquiry！在這裡跟小組一起完成科展專題吧: D">
			<img src="<?php echo SITE_PATH; ?>model/images/logo_all.png">
	...
	<div id="content" <?php if(isset($_SESSION['p_id']) == ""){ echo "style='margin-top: 33px;'"; }?>>
		<!-- 中間內容 -->
		<div class="log_btn <?php if(isset($_SESSION['p_id']) == ""){ echo 'display'; }?>" id="position" value="現在位置">現在位置：<?php echo $page_url; ?></div>