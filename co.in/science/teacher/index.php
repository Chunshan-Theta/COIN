						...
						while($row = mysql_fetch_array($qry)){
							...
							echo "<tr id='info_table'>".
									"<td align='center'>".$pname."</td>".
								  	"<td align='center'>".$help_type."</td>".
								  	"<td>".$row['description']."</td>".
								  	"<td align='center'>".date('Y-m-d', strtotime($row['help_time']))."</td>".
								  "</tr>";
						}
					}else{
						echo "<tr><td align='center' colspan='4'>尚未有任何廣播。</td></tr>";
					}
				?>
			</table>
		</fieldset>
						...
						while($row = mysql_fetch_array($qry)){
							...
							echo "<tr id='".$row["h_id"]."'>".
									...
									"<td align='center'>".$pname."</td>".
								  	"<td align='center'>".$help_type."</td>".
								  	"<td>".$row['description']."</td>".
								  	"<td align='center'><button class='help_reply log_btn' value='回覆學生問題'>回覆</button></td>".
								  "</tr>";
						}
					}else{
						echo "<tr align='center'><td colspan='5'>尚未有任何求助內容。</td></tr>";
					}
				?>
			</table>
		</fieldset>
								...
								if($row['stage'] == '5-3'){
									...
									if(mysql_num_rows($q_qry) == 0){		// 確定無值
										echo "<tr class='".$row['stage']."' id='".$row['p_id']."'>".
												"<td align='center'>".date('Y-m-d', strtotime($row['examine_start_time']))."</td>".
												"<td align='center'>".$pname."</td>".
												"<td>".$stage." ".$sname."</td>".
												"<td align='center' class='log_btn' value='詳情【".$stage." ".$sname."】'><span class='examine_detail' value='".$question."'>詳情</span></td>".
												"<td align='center' class='log_btn'>
													<button class='examine_qna' value='撰寫提問單'>撰寫提問單</button>
												</td>".
											  "</tr>";
									}else{
										echo "<tr class='".$row['stage']."' id='".$row['p_id']."'>".
											...
											"<td>".$stage." ".$sname."</td>".
											"<td align='center' class='log_btn' value='詳情【".$stage." ".$sname."】'><span class='examine_detail' value='".$question."'>詳情</span></td>".
											"<td align='center' class='log_btn' value='審核【".$stage." ".$sname."】'>
