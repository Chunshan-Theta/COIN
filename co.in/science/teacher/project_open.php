...
/*------------------------------專題管理：決定開放程度------------------------------*/
	...
	$("input[type=checkbox]").change(function(){
		...
		$(".open_table").attr("value", open_list);
	});
...
/*------------------------------專題管理：填寫階段資料------------------------------*/
	...
	$(".save_open_info").click(function(){
		...
		for(var i = 1; i < $(".open_table").attr("value"); i++){
			open_info_list.push($("#open_form input[name=write_open_info"+ i +"]").val());
		}
		console.log(open_info_list);
...
<div id="centercolumn">
	...
	<div id="open_pages">
		<h1 align="center">填寫階段資料</h1>
			<form id="open_form">
				<table class="open_table" value="0">
					<tr class="open_info2">
						<th>1-1 決定研究主題</th>
					...
					<tr class="open_info13">
						<th>4-1 進行研究討論</th>
						<td colspan="6"><textarea name="write_open_info13"></textarea></td>
					</tr>
					<tr class="open_info14">
						<th>4-2 撰寫研究結論</th>
						<td colspan="6"><textarea name="write_open_info14"></textarea></td>
					</tr>
				</table>
			</form>
